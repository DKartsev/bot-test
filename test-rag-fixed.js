...
async function testRAGFixed() {
  console.log('🔍 Тестируем исправленный RAG сервис...');
  ...
  try {
    ...
    if (sortedResults.length > 0 && sortedResults[0].similarity > 0.1) {
      console.log('\n🤖 Тестируем генерацию ответа...');
      ...
      console.log('❌ Недостаточно похожих чанков для генерации ответа');
    }
