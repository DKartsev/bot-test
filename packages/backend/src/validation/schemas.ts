...
export const createChatSchema = z.object({
  ...
  status: z.enum(['waiting', 'in_progress', 'closed', 'waiting_for_operator']).default('waiting'),
...
export const updateChatSchema = z.object({
  status: z.enum(['waiting', 'in_progress', 'closed', 'waiting_for_operator']).optional(),
...
export const chatFiltersSchema = z.object({
  status: z.array(z.enum(['waiting', 'in_progress', 'closed', 'waiting_for_operator'])).optional(),
