...
describe('Auth Middleware', () => {
  ...
  describe('IP Allowlist', () => {
    ...
    it('should block requests from non-whitelisted IPs', async () => {
      ...
      const { code, send } = reply as unknown as { code: unknown; send: unknown };
  ...
  describe('Rate Limiting', () => {
    ...
    it('should block requests exceeding rate limit', async () => {
      ...
      await authMiddleware(request, reply);
      const { code: code1 } = reply as unknown as { code: unknown };
      expect(code1).not.toHaveBeenCalledWith(429);
      ...
      const { code: code2, send: send2 } = reply2 as unknown as { code: unknown; send: unknown };
      expect(code2).toHaveBeenCalledWith(403);
  ...
  describe('Request Headers', () => {
    it('should set CORS headers', async () => {
      ...
      const { header } = reply as unknown as { header: unknown };
    ...
    it('should handle OPTIONS request', async () => {
      ...
      const { send } = reply as unknown as { send: unknown };
